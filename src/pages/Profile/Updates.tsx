...
import EditsFamily from './EditsFamily';
import EditsOwner from './EditsOwner';
    ...
    return (
        <div>
            ...
            <div className="tab-content">
                {activeTab === 'owner' && <EditsOwner onAddOwner={function (owner: OwnerData): void {
                    throw new Error('Function not implemented.');
                } } />}
                {activeTab === 'family' && <EditsFamily />}
            </div>
        </div>
    );
};
